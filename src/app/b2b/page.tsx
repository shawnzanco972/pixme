...
import { PLATE_CM } from "@/lib/b2b-pricing";
...
const FAQS: { q: string; a: string }[] = [
  {
    ...
    a: "כן. זו לא מתנה דיגיטלית — כל עובד מקבל ערכת פסיפס לבנים פיזית משלו, עם מדריך הרכבה ורשימת חלקים. המחיר מחושב לפי מספר העובדים והגודל שבחרתם.",
  },
  {
    q: "מה הגודל של פסיפס?",
    a: `אתם בוחרים את הגודל לכל עובד — מפסיפס קומפקטי של כ-${PLATE_CM * 2}×${PLATE_CM * 2} ס״מ (מושלם לדיוקן קלוז-אפ של פנים או חיית מחמד) ועד פסיפס מרשים של כ-${PLATE_CM * 5}×${PLATE_CM * 5} ס״מ לקיר. בכל גודל, העובד ממסגר את התמונה שלו כך שתתאים בדיוק.`,
  },
  {
    q: "כמה זמן לוקח להרכיב?",
    a: "תלוי בגודל: פסיפס קטן הוא ערב אחד, ופסיפס גדול (למשל 3×3) הוא פרויקט של כמה שעות — פעילות נחמדה לערב משפחתי.",
  },
  {
    q: "אפשר לתת לעובד מסוים פסיפס גדול יותר?",
    a: "כן. בלוח הבקרה של הפרויקט אפשר להגדיל את הפסיפס של עובד מסוים (למשל לציון ותק או אבן דרך) — והמערכת מאזנת זאת מול שאר ההזמנה. אפשר גם להוסיף תקציב בכל שלב.",
  },
  {
